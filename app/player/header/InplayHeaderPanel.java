...
public class InplayHeaderPanel extends JPanel {
	...
	public InplayHeaderPanel() {
        ...
        loginLabel.addMouseListener(new MouseAdapter(){
			...
			public void mouseClicked(MouseEvent arg0) {
					if(InplayPlayerContext.isUserLoggedIn()) {
						...
						InplayComponentFactory.getLoginFrame().getLoginFrame().setVisible(true);
					}
			}
        });
        ...
        String path = InplayConstants.LOCAL_IMAGE_DIR + "/"  +"inplayFinalLogo.png";
...
//        closePanel.setBackground(Color.BLACK);
        ...
        InplayRatingsPanel ratingsPanel = InplayComponentFactory.getRatingsPanel();
	...
	private void addScrollingSupport() {
	      ...
	      addMouseMotionListener(new MouseMotionAdapter() {
	        public void mouseDragged(MouseEvent e) {
	          ...
	          InplayComponentFactory.getMainFrame().setLocation(p.x + e.getX() - point.x, p.y + e.getY() - point.y);
	        }
	      });
